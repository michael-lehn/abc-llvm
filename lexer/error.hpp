...
void unexpected(lexer::Token locToken, lexer::TokenKind expectedTokenKind);
void unexpectedAfter(lexer::Token locToken, lexer::TokenKind expectedTokenKind);
void unexpectedBefore(lexer::Token locToken,
                      lexer::TokenKind expectedTokenKind);
